...
class Unet(nn.Module):
    def __init__(self, batch_size, input_size=256):
        ...
        self.linear = nn.Linear(int(1024*(input_size/16)*(input_size/16)), 1)
    ...
    def forward(self, input_img):
        ...
        # Linear layer
        feature_vector = self.linear(img_5_2.reshape(self.batch_size, -1))
        cancer = self.sigmoid_cancer(feature_vector)
